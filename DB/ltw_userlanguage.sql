...
CREATE TABLE `userlanguage` (
  ...
  KEY `UserLanguage_fk1` (`language_id`),
  CONSTRAINT `UserLanguage_fk0` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `UserLanguage_fk1` FOREIGN KEY (`language_id`) REFERENCES `language` (`language_id`)
